# Artist Statement: Exposure

*Photography Series on depression and vulnerability*
...
But what depression does most profoundly is leave you feeling *exposed*.
...
I created *Exposure* because I needed people to understand this experience.
...
**Themes:** Depression, vulnerability, emotional exposure, mental health, isolation, visibility

**Year:** 2023

---

## Exhibition Text (Short Version)

*Exposure* visualizes the experience of depression—the slow unraveling, the raw vulnerability, the feeling of being stripped bare. Through photography, the series makes visible what mental illness often keeps hidden, creating space for recognition and understanding.

---

## SEO Keywords

`photography about depression`, `mental health photo series`, `vulnerability in art`, `contemporary photography mental illness`, `emotional exposure art`, `depression awareness art`, `fine art photography feelings`, `psychological photography`
